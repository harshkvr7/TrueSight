...
const Home = () => {
    return (
        <div className="relative my-12 flex w-full h-screen flex-col items-center bg-gray-900">
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-0 sm:gap-x-4">
                ...
                <a href="#demo" className="flex flex-row items-center justify-center gap-x-2 rounded-lg border border-blue-500 px-10 py-3 text-blue-500 hover:bg-blue-500 hover:text-white transition duration-200">
                    Learn More →
                </a>
            </div>
        </div>
